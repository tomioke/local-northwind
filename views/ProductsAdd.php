...
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fproductsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fproductsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fproductsadd.lists.CategoryID = <?= $Page->CategoryID->toClientList($Page) ?>;
    fproductsadd.lists.SupplierID = <?= $Page->SupplierID->toClientList($Page) ?>;
    fproductsadd.lists.Discontinued = <?= $Page->Discontinued->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fproductsadd" id="fproductsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
