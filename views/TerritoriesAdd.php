...
loadjs.ready("head", function () {
    ...
    fterritoriesadd = currentForm = new ew.Form("fterritoriesadd", "add");
    ...
    // Validate form
    fterritoriesadd.validate = function () {
    ...
    // Form_CustomValidate
    fterritoriesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fterritoriesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fterritoriesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fterritoriesadd" id="fterritoriesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
