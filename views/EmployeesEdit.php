...
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    femployeesedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployeesedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="femployeesedit" id="femployeesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php
    if (in_array("employeeterritories", explode(",", $Page->getCurrentDetailTable())) && $employeeterritories->DetailEdit) {
?>
