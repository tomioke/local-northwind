...
return [
    ...
    "employeeterritories" => \DI\create(Employeeterritories::class),
    "order_details" => \DI\create(OrderDetails::class),
    "orders" => \DI\create(Orders::class),
    "products" => \DI\create(Products::class),
    "region" => \DI\create(Region::class),
    "shippers" => \DI\create(Shippers::class),
    "suppliers" => \DI\create(Suppliers::class),
    "territories" => \DI\create(Territories::class),
];
