...
class Customers extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // CustomerID
        $this->CustomerID = new DbField('customers', 'customers', 'x_CustomerID', 'CustomerID', '`CustomerID`', '`CustomerID`', 200, 255, -1, false, '`CustomerID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CompanyName
        $this->CompanyName = new DbField('customers', 'customers', 'x_CompanyName', 'CompanyName', '`CompanyName`', '`CompanyName`', 200, 255, -1, false, '`CompanyName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ContactName
        $this->ContactName = new DbField('customers', 'customers', 'x_ContactName', 'ContactName', '`ContactName`', '`ContactName`', 200, 255, -1, false, '`ContactName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ContactTitle
        $this->ContactTitle = new DbField('customers', 'customers', 'x_ContactTitle', 'ContactTitle', '`ContactTitle`', '`ContactTitle`', 200, 255, -1, false, '`ContactTitle`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Address
        $this->Address = new DbField('customers', 'customers', 'x_Address', 'Address', '`Address`', '`Address`', 200, 255, -1, false, '`Address`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Address->Sortable = true; // Allow sort
        $this->Address->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Address->Param, "CustomMsg");
        $this->Fields['Address'] = &$this->Address;

        // City
        $this->City = new DbField('customers', 'customers', 'x_City', 'City', '`City`', '`City`', 200, 255, -1, false, '`City`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->City->Sortable = true; // Allow sort
        $this->City->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->City->Param, "CustomMsg");
        $this->Fields['City'] = &$this->City;

        // Region
        $this->Region = new DbField('customers', 'customers', 'x_Region', 'Region', '`Region`', '`Region`', 200, 255, -1, false, '`Region`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PostalCode
        $this->PostalCode = new DbField('customers', 'customers', 'x_PostalCode', 'PostalCode', '`PostalCode`', '`PostalCode`', 200, 255, -1, false, '`PostalCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Country
        $this->Country = new DbField('customers', 'customers', 'x_Country', 'Country', '`Country`', '`Country`', 200, 255, -1, false, '`Country`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Phone
        $this->Phone = new DbField('customers', 'customers', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, 255, -1, false, '`Phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Phone->Sortable = true; // Allow sort
        $this->Phone->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Phone->Param, "CustomMsg");
        $this->Fields['Phone'] = &$this->Phone;

        // Fax
        $this->Fax = new DbField('customers', 'customers', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, 255, -1, false, '`Fax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            ...
            $val = $this->CustomerID->OldValue !== null ? $this->CustomerID->OldValue : $this->CustomerID->CurrentValue;
        }
        if ($val === null) {
    ...
    {
        $json = "";
        $json .= "CustomerID:" . JsonEncode($this->CustomerID->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->CustomerID->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->CustomerID->CurrentValue);
        } else {
