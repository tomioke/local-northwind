 ...
 * Page class
 */
class ShippersDelete extends Shippers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ShippersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ShippersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ShippersList"); // Return to list
                return;
            }
        }
