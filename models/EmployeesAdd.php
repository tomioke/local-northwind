...
class EmployeesAdd extends Employees
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->PhotoPath->CurrentValue = null;
        $this->PhotoPath->OldValue = $this->PhotoPath->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['PhotoPath'] = $this->PhotoPath->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // HireDate
        $this->HireDate->setDbValueDef($rsnew, $this->HireDate->CurrentValue, null, false);
        ...
        // PhotoPath
        $this->PhotoPath->setDbValueDef($rsnew, $this->PhotoPath->CurrentValue, null, false);
