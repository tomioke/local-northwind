...
class Shippers extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ShipperID
        $this->ShipperID = new DbField('shippers', 'shippers', 'x_ShipperID', 'ShipperID', '`ShipperID`', '`ShipperID`', 3, 11, -1, false, '`ShipperID`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // CompanyName
        $this->CompanyName = new DbField('shippers', 'shippers', 'x_CompanyName', 'CompanyName', '`CompanyName`', '`CompanyName`', 200, 255, -1, false, '`CompanyName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Phone
        $this->Phone = new DbField('shippers', 'shippers', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, 255, -1, false, '`Phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            ...
            $val = $this->ShipperID->OldValue !== null ? $this->ShipperID->OldValue : $this->ShipperID->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ShippersEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ShippersAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ShippersView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ShippersView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ShippersAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ShippersAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ShippersEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ShippersAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ShippersDelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "ShipperID:" . JsonEncode($this->ShipperID->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->ShipperID->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->ShipperID->CurrentValue);
        } else {
