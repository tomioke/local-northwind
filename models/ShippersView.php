 ...
 * Page class
 */
class ShippersView extends Shippers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ShippersView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("ShipperID") ?? Route("ShipperID")) !== null) {
            $this->RecKey["ShipperID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ShipperID") ?? Route("ShipperID")) !== null) {
                ...
                $this->RecKey["ShipperID"] = $this->ShipperID->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->ShipperID->setQueryStringValue($keyValue);
                $this->RecKey["ShipperID"] = $this->ShipperID->QueryStringValue;
            } else {
                $returnUrl = "ShippersList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ShippersList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ShippersList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
