 ...
 * Page class
 */
class ShippersEdit extends Shippers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ShippersEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("ShippersList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ShippersList") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // ShipperID
            $this->ShipperID->EditAttrs["class"] = "form-control";
            $this->ShipperID->EditCustomAttributes = "";
            $this->ShipperID->EditValue = $this->ShipperID->CurrentValue;
            $this->ShipperID->EditValue = FormatNumber($this->ShipperID->EditValue, 0, -2, -2, -2);
            $this->ShipperID->ViewCustomAttributes = "";
