...
class EmployeesList extends Employees
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->PhotoPath->AdvancedSearch->toJson(), ","); // Field PhotoPath
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function restoreFilterList()
    {
        ...
        // Field PhotoPath
        $this->PhotoPath->AdvancedSearch->SearchValue = @$filter["x_PhotoPath"];
        $this->PhotoPath->AdvancedSearch->SearchOperator = @$filter["z_PhotoPath"];
        $this->PhotoPath->AdvancedSearch->SearchCondition = @$filter["v_PhotoPath"];
        $this->PhotoPath->AdvancedSearch->SearchValue2 = @$filter["y_PhotoPath"];
        $this->PhotoPath->AdvancedSearch->SearchOperator2 = @$filter["w_PhotoPath"];
        $this->PhotoPath->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->BirthDate, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->HireDate, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->ReportsTo, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->PhotoPath, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->PhotoPath); // PhotoPath
